...
public class Intake extends SubsystemBase {
  SparkMax intakeMotor1 = new SparkMax(Constants.IntakeConstants.INTAKEID, MotorType.kBrushless); // 10 and
  SparkMax intakeMotor2 = new SparkMax(Constants.IntakeConstants.INTAKEID2, MotorType.kBrushless);// 11
